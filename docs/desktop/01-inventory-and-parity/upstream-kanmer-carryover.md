...
| INTK-003 | intake-processing | backlog | fix | — | Recover dispatched intake work whose queue message never arrives | gateway-worker-ticket (board [[INTK-002]]) | 07 (Graph/queue intake) | intake-processing |
