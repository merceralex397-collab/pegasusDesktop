...
| `Presentation/OperatorLabels.cs` (685; 24 `.cshtml` consumers) | EXTRACT to the shared assembly (`Pegasus.Contracts` preferred) | Pure code→vocabulary map, no ASP.NET dependency; losing it would silently regress business vocabulary | DSK-05-23 |
