...
| **No prototype** | `Pages/Search/Index.cshtml` | `Cases list and search — replaces Pages/Cases/Index.cshtml.cs, Pages/Search/Index.cshtml.cs (UI-07)` (line 163) | No prototype bytes | The backing query shares the Cases screen; no separate approved prototype was listed. |
