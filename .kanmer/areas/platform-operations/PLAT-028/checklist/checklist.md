...
- [x] Confirm the research and files map against the ticket plan and current origin/dev source.
- [x] Extract one shared inline-image predicate helper in the existing intake-reader partial class.
- [x] Preserve EML explicit-attachment behavior and DOC/MSG inline/content-id behavior.
- [x] Run focused document-extraction tests covering both source paths.
