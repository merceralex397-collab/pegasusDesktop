...
- [ ] Add the same path to the server entry point created by [[FND-028]] (plan handle `DSK-02-03`), or record in the plan that [[FND-028]] has not landed and the entry is deferred. — deferred: Pegasus.Server.slnf is absent until FND-028 lands.
