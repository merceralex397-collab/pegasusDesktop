...
- [x] Create `docs/adr/0108-desktop-webview2-report-rendering.md` with the eight-key frontmatter, `status: proposed`, `supersedes: []`, `superseded_by: []`, `related_frd: [FRD-11]`
