...
- [ ] Read `docs/desktop/03-gateway-api-and-data/README.md:160-168` and § 7 (`:249-286`), `endpoint-map.md` § Conventions, `src/Pegasus.Web/Mcp/AutomationMcp.cs` whole, and `src/Pegasus.Web/Program.cs` at `:246`, `:517-520`, `:625-628`, `:750-756`, `:820`, `:874-900`, `:939-966`, `:969-977`; call `get_doc_gates GWY-002`; `take_ticket` on branch `task/desktop-gateway-group`, worktree `../pegasus-worktrees/desktop-gateway-group`, from `origin/dev`.
