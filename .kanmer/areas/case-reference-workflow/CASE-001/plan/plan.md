...
## Live exact-head CI and merge-state recheck — 2026-08-26

PR #4 is live state `MERGED` into `dev`, with head `737059ddc497f072b8678c8cd2f3e61aa04b6b00`. Repository-check run `32883994941`, attempt 4, completed `success` at the exact head. Its required jobs passed: changes, documentation, local-development-scripts, reference-data, unit, SQL integration shards 1–3, SQL coverage, and browser; infrastructure was path-skipped. SQL shard 3 passed on the retry, and SQL coverage reported that all 876 enumerated tests ran exactly once. This supersedes the earlier attempt-1 deadlock note; no code change was made for the retry.

Configured-remote refresh confirms `origin/dev=fff7e14178f1be6e3d4f2fbc5a5401799ba69409` contains the ticket commit, while `origin/main=191ddf334208b8966dc5e32f4f597e434a086233` does not. PR #15 is open and clean with head `fff7e14178f1be6e3d4f2fbc5a5401799ba69409`; proof cannot be written or this ticket moved to Done until the exact reviewed `dev` history is promoted to `main` under the repository's required authorization boundary.
