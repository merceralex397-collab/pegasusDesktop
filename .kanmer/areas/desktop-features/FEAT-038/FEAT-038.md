...
3. Create or open `docs/adr/0108-isolated-webview2-report-rendering.md` with valid YAML frontmatter matching the conventions used by the existing ADRs (compare `docs/adr/0025-integrate-renderer-and-extractor-into-the-application.md` and `docs/adr/0028-run-integrated-renderer-in-web-container-app.md` for the exact field set). Status starts `proposed`.
...
11. Add the ADR row to `docs/adr/README.md` and any relation notes to ADR-0025 and ADR-0028. Do not edit those ADRs' bodies.
...
- [ ] `docs/adr/0108-isolated-webview2-report-rendering.md` exists with valid frontmatter and the reserved number 0108 — not a "next free" number.
...
- [ ] Exactly one ADR-0108 exists in the repository; `docs/adr/README.md` lists it.
...
Tier 1 obliges consistency evidence only: the document exists in the allowed root, links resolve, frontmatter is valid and the index row is present. It proves nothing about the renderer, which is [[DSK-07-14]] and [[DSK-07-15]].

## Documentation changes

- `docs/adr/0108-isolated-webview2-report-rendering.md` — new ADR
- `docs/adr/README.md` — index row and the relation notes to ADR-0025 and ADR-0028
